...
public class UserController {
    ...
    """)
    @PostMapping("/signup")
    public ResponseEntity signUp (@RequestBody @Valid UserDTO.RegisterRequest registerRequest) throws RuntimeException {
    ...
    public ResponseEntity<UserDTO.LoginResponse> authenticate(@RequestBody UserDTO.Login loginRequest, HttpServletRequest request) {
