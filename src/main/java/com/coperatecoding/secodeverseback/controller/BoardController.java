...
public class BoardController {
    ...
    public ResponseEntity<BoardAndImageDTO.DetailResponse> getBoard(@PathVariable Long boardPk)
    ...
    public ResponseEntity deleteBoard(@AuthenticationPrincipal User user, @PathVariable Long boardPk
    ) throws NoSuchElementException, ForbiddenException {
        try{
